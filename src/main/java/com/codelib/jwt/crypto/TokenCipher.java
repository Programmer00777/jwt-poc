...
/**
 * Handle ciphering and deciphering of the token using AES-GMC.
 * <p>
 * Use Google TINK to handle ciphering operations in order to use
 * crypto built-in best practices provided by this library.
 */
public class TokenCipher {
    ...
    public String decipherToken(String jwtInHex, KeysetHandle keysetHandle) throws Exception {
        ...
        return DatatypeConverter.printHexBinary(decipheredToken);
    }
}
